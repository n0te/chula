            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase">ตารางการจองห้องแล็ปทั้งหมด</span>
                    </div>
...
<script>
                        ...
                        $('#tblReviewform').DataTable({
                            ...
                            columns: [//`bookingid``bookingdate``bookingstarttime``bookingendtime``equipmentname``equipmentpicturename`
                                ...
                                {"bVisible": true, "bSearchable": false, "bSortable": false,
                                    ...
                                    "mData": null,
                                    "mRender": function (data, type, full) {
                                        return "<a class='btn btn-danger btn-sm' href='#' onclick='return OpenDelete(\"" + full.anibookingid + "\")'><span class='glyphicon glyphicon-trash'></span> ลบ</a>";
                    ...
                    function DeleteByID() {
                        $.ajax({
                            url: '/deleteAniBookingByID/' + $("#hidbiobookid").val(),
                            method: 'get',
                            dataType: 'json',
                            contentType: false,
                            processData: false,
                            ...
                            success: function (data) {
                                if (data.message === 'saved') {
                                    ...
                                    $('#mdlGroupCfmDel').modal('toggle');
                                    sudoNotify.success("ลบการจองห้องแล๊ปเรียบร้อย");
                                }
                            }
                        });
                    }
