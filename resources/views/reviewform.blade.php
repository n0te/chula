                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/approveformbyadmin/{{$Formreq->FormReqID}}" data-toggle="confirmation" data-original-title="คุณแน่ใจว่าจะอนุมัติรายการนี้" data-popout="true" title=""  class="btn btn-outline btn-circle green btn-sm green">
                                                <i class="fa fa-trash-o"></i> อนุมัติ </a>
                                            <a href="#mdlReject" data-toggle="modal" onclick="OpenRejectForm('{{$Formreq->FormReqID}}'); return false;" class="btn btn-outline btn-circle yellow btn-sm yellow">
