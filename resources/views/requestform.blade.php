        ...
        <div class="col-md-12">
            ...
            <div class="profile-content">
                ...
                <div class="portlet light bordered" id="reqform">
                    <form role="form" class="form-horizontal" action="{{ url('/formreq')}}" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        <div id="formwiz">
                            ...
                            <fieldset style=" width: 100%;">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control placeholder-no-fix" type="text" placeholder="" name="txtHeadOfProject" id="txtHeadOfProject" value="{{$userwithtitle[0]->name}} {{$userwithtitle[0]->firstname}} {{$userwithtitle[0]->lastname}}" readonly/>
                                        </div>
                                    </div>
                                    <div class="form-group">
