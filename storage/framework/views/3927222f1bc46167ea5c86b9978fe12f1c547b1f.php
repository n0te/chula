            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase">แก้ไขประกาศ MRC</span>
                    </div>
...
<script>
                    ...
                    $(document).ready(function () {
                        ...
                        //var markupStr = '<?php echo e(htmlspecialchars_decode($eqcs)); ?>';
                        //$('#summernote').summernote('code', markupStr);
                        $.ajax({
                            url: '/gethtmlannouncementmrc',
                            method: 'get',
                            dataType: 'json',
                            contentType: false,
                            processData: false,
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.message === 'saved') {
                                    sudoNotify.success("แก้ไขประกาศ MRC เรียบร้อย");
                                }
                            }
