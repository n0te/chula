            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase">ตารางการระงับการใช้งาน Animal House ชั่วคราวทั้งหมด</span>
                    </div>
    ...
    $(document).ready(function () {
        $('#tblReviewform').DataTable({
            ...
            columns: [
                ...
                {data: 'anibantime', name: 'anibantime'},
                {data: 'anibanstartdate', name: 'anibanstartdate'},
                {data: 'anibanenddate', name: 'anibanenddate'},
                {"bVisible": true, "bSearchable": false, "bSortable": false,
                    ...
                    "mData": null,
                    "mRender": function (data, type, full) {
                        if (full.anibanactive === '1') {
                            return "<select onchange='return setActive(\"" + full.anibanid + "\",this)' class='form-control'><option value='1' selected>ระงับการใช้งาน</option><option value='0'>ยกเลิกระงับการใช้งาน</option></select>";
                        } else {
                            return "<select onchange='return setActive(\"" + full.anibanid + "\",this)' class='form-control'><option value='1'>ระงับการใช้งาน</option><option value='0' selected>ยกเลิกระงับการใช้งาน</option></select>";
                        }
