                            ...
                            <div>
                                <div class="form-group" hide student>
                                    <label class="control-label">อื่นๆ</label>
                                        ...
                                        <input class="form-control placeholder-no-fix" type="text"  name="orther_specify" value="<?php echo e(old('orther_specify')!=null ? old('orther_specify') : $reviewuser->orther_specify); ?>" />
                                </div>
                                <div class="form-group" hide student>
