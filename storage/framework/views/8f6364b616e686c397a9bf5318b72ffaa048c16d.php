...
<div class="page-content">
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>รายงานการนัดพบอาจารย์ทั้งหมด</span>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase">แผนภูมิแท่งแสดงการนัดพบอาจารย์ทั้งหมด</span>
                    </div>
...
//        formData.append('sd', $("#txtStartDate").val());
//        formData.append('ed', $("#txtEndDate").val());
        window.open('/bioexporttoexcel/' + $("#txtStartDate").val() + '/' + $("#txtEndDate").val());
