...
<div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> <?php echo e($user->firstname); ?> Profile 
                 ...
                 <form role="form" class="profile-form form-bordered" action="<?php echo e(url('/profile')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="control-label">คำนำหน้า</label>
                                ...
                                <select name="title" class="form-control">
                                    ...
                                    <option value='<?php echo e($title->id); ?>' <?php if(old( 'title') != null): ?> <?php echo e((old( 'title')== $title->id) ? 'selected' : ''); ?> <?php else: ?> <?php echo e($user->title == $title->id ? 'selected' : ''); ?> <?php endif; ?> > <?php echo e($title->name); ?>
                        ...
                        <div class="form-group">
                            <label class="control-label">ชื่อจริง</label>
                                ...
                                <input class="form-control placeholder-no-fix" type="text" placeholder="ชื่อจริง" name="firstname" value="<?php echo e(old('firstname')!=null ? old('firstname') : $user->firstname); ?>" />
                        </div>
                        <div class="form-group">
                            ...
                            <label class="control-label">นามสกุล</label>
                                ...
                                <input class="form-control placeholder-no-fix" type="text" placeholder="นามสกุล" name="lastname" value="<?php echo e(old('lastname')!=null ? old('lastname') : $user->lastname); ?>" />
                        ...
                        <div class="form-group">
                            <label class="control-label">เพศ</label>
                                ...
                                <select name="sex" class="form-control" disabled>
                                    ...
                                    <option value='<?php echo e($sex->id); ?>' <?php if(old('sex')!=null): ?> <?php echo e(old( 'sex')== $sex->id ? 'selected' : ''); ?> <?php elseif($user->sex == $sex->id): ?> <?php echo e('selected'); ?> <?php endif; ?> > <?php echo e($sex->name); ?>
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label">Email</label>
                                ...
                                <input class="form-control placeholder-no-fix" type="text" placeholder="Email" name="email" value="<?php echo e(old('email')!=null ? old('email') : $user->email); ?>" disabled/>
                        </div>
                        <div class="form-group">
                            <label class="control-label">เกิดวันที่</label>
                                <input data-date-format="dd-mm-yyyy" class="form-control form-control-inline date-picker" size="16" type="text" value="<?php echo e(old('dob')!=null ? old('dob') : $user->get_userDOB()); ?>" name="dob" disabled>
                        </div>
                        <div class="form-group">
                            <label class="control-label">สัญชาติ</label>
                                ...
                                <select name="nationality" class="form-control" disabled>
                                    ...
                                    <option value='<?php echo e($nationality->id); ?>' <?php if(old( 'nationality')!=null): ?> <?php echo e(old('nationality')== $nationality->id ? 'selected' : ''); ?> <?php elseif($user->nationality == $nationality->id): ?> <?php echo e('selected'); ?> <?php endif; ?> > <?php echo e($nationality->name); ?>
                        ...
                        <div class="form-group">
                            <label class="control-label">กลุ่มสมาชิก</label>
                                ...
                                <select name="type" class="form-control" disabled>
                                    ...
                                    <option value='<?php echo e($type->id); ?>' <?php if(old('type')!=null): ?> <?php echo e(old('type')==$type->id ? 'selected' : ''); ?> <?php elseif($user->type == $type->id): ?> <?php echo e('selected'); ?> <?php endif; ?> > <?php echo e($type->name); ?>
                        ...
                        <div class="form-group user_occupation_panel" style="display:none;">
                            <label class="control-label">ประเภทของบุคคลากร</label>
                                ...
                                <select name="occupation" class="form-control" disabled>
                                    ...
                                    <option value='<?php echo e($occupation->id); ?>' <?php if(old( 'occupation')!=null): ?> <?php echo e(old('occupation')==$occupation->id ? 'selected' : ''); ?> <?php elseif($user->occupation == $occupation->id): ?> <?php echo e('selected'); ?> <?php endif; ?> > <?php echo e($occupation->name); ?>
                        ...
                        <div id="pre-hidden-group" style="display:none;">
                            <div>
                                <div class="form-group" hide other>
                                    <label class="control-label">อื่นๆ</label>
                                        ...
                                        <input class="form-control placeholder-no-fix" type="text" placeholder="อื่นๆ" name="orther_specify" value="<?php echo e(old('orther_specify')!=null ? old('orther_specify') : $user->orther_specify); ?>" disabled/>
                                </div>
                                <div class="form-group" hide student>
                                    <label class="control-label">รหัสนิสิต</label>
                                        ...
                                        <input class="form-control placeholder-no-fix" type="text" placeholder="รหัสนิสิต" name="student_id" value="<?php echo e(old('student_id')!=null ? old('student_id') : $user->student_id); ?>" disabled/>
                                </div>
                                <div class="form-group" hide student>
                                    <label class="control-label">อาจารย์ที่ปรึกษา</label>
                                        <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                                        <label class="control-label visible-ie8 visible-ie9">อาจารย์ที่ปรึกษา</label>
                                        <input class="form-control placeholder-no-fix" type="text" placeholder="อาจารย์ที่ปรึกษา" name="advisor" value="<?php echo e(old('advisor')!=null ? old('advisor') : $user->advisor); ?>" disabled/>
                                </div>
                                <div class="form-group" hide student>
                                    <label class="control-label">หัวข้องานวิจัย</label>
                                        <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                                        <label class="control-label visible-ie8 visible-ie9">หัวข้องานวิจัย</label>
                                        <input class="form-control placeholder-no-fix" type="text" placeholder="หัวข้องานวิจัย" name="researchtopic" value="<?php echo e(old('researchtopic')!=null ? old('researchtopic') : $user->researchtopic); ?>" disabled/> 
                                </div>
                                <div class="form-group department-panel" hide>
                                    <label class="control-label">อาจารย์ที่ปรึกษา</label>
                                        ...
                                        <select name="department" class="form-control" disabled>
                                            ...
                                            <option value='<?php echo e($department->id); ?>' <?php if(old( 'department')!=null): ?> <?php echo e(old( 'department')== $department->id ? 'selected' : ''); ?> <?php elseif($user->department == $department->id): ?> <?php echo e('selected'); ?> <?php endif; ?> > <?php echo e($department->name); ?>
                            ...
                            <div class="form-group" hide outsider>
                                <label class="control-label">มหาวิทยาลัย/บริษัท</label>
                                    ...
                                    <input class="form-control placeholder-no-fix" type="text" placeholder="มหาวิทยาลัย/บริษัท" name="company" value="<?php echo e(old('company')!=null ? old('company') : $user->company); ?>" disabled/>
                            </div>
                            <div class="form-group">
                                <label class="control-label">เลขบัตรประจำตัวประชาชน</label>
                                    ...
                                    <input class="form-control placeholder-no-fix" type="text" placeholder="เลขบัตรประจำตัวประชาชน" name="citizen_id" value="<?php echo e(old('citizen_id')!=null ? old('citizen_id') : $user->citizen_id); ?>" disabled/>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Passport ID</label>
                                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                                    <label class="control-label visible-ie8 visible-ie9">Passport ID</label>
                                    <input class="form-control placeholder-no-fix" type="text" placeholder="Passport ID" name="passport_id" value="<?php echo e(old('passport_id')!=null ? old('passport_id') : $user->passport_id); ?>" disabled/>
                            </div>
                            <div class="form-group">
                                <label class="control-label">ที่อยู่</label>
                                    <label class="control-label visible-ie8 visible-ie9">ที่อยู่</label>
                                    <input class="form-control placeholder-no-fix" type="text" placeholder="ที่อยู่" name="address" value="<?php echo e(old('address')!=null ? old('address') : $user->address); ?>" />
                            </div>

                            <div class="form-group">
                                <label class="control-label">โทรศัพท์</label>
                                    <label class="control-label visible-ie8 visible-ie9">โทรศัพท์</label>
                                    <input class="form-control placeholder-no-fix" type="text" placeholder="โทรศัพท์" name="tel" value="<?php echo e(old('tel')!=null ? old('tel') : $user->tel); ?>" />
                            </div>
                            <div class="form-group">
        ...
        <form class="changepassword-form" action="<?php echo e(url('/changepassword')); ?>">
                                                        <div class="alert alert-danger display-hide">
                    <button class="close" data-close="alert"></button>
                </div>
                                                            <div class="form-group">
