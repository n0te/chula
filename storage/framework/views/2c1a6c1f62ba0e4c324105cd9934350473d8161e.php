                 ...
                 <form role="form" class="profile-form form-bordered" action="<?php echo e(url('/profile')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="control-label">เกิดวันที่</label>
                                <input data-date-format="dd-mm-yyyy" class="form-control form-control-inline date-picker" size="16" type="text" value="<?php echo e(old('dob')!=null ? old('dob') : $user->get_userDOB()); ?>" name="dob">
                        </div>
                        <div class="form-group">
                        ...
                        <div id="pre-hidden-group" style="display:none;">
                            <div>
                                <div class="form-group" hide student>
                                    <label class="control-label">รหัสนิสิต</label>
                                        ...
                                        <input class="form-control placeholder-no-fix" type="text" placeholder="รหัสนิสิต" name="student_id" value="<?php echo e(old('student_id')!=null ? old('student_id') : $user->student_id); ?>" />
                                </div>
                                <div class="form-group" hide student>
                                    <label class="control-label">อาจารย์ที่ปรึกษา</label>
                                        <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                                        <label class="control-label visible-ie8 visible-ie9">อาจารย์ที่ปรึกษา</label>
                                        <input class="form-control placeholder-no-fix" type="text" placeholder="อาจารย์ที่ปรึกษา" name="advisor" value="<?php echo e(old('advisor')!=null ? old('advisor') : $user->advisor); ?>" />
                                </div>
                                <div class="form-group" hide student>
                                    <label class="control-label">หัวข้องานวิจัย</label>
                                        <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                                        <label class="control-label visible-ie8 visible-ie9">หัวข้องานวิจัย</label>
                                        <input class="form-control placeholder-no-fix" type="text" placeholder="หัวข้องานวิจัย" name="researchtopic" value="<?php echo e(old('researchtopic')!=null ? old('researchtopic') : $user->researchtopic); ?>" /> 
                                </div>
                            ...
                            <div class="form-group" hide outsider>
                                <label class="control-label">มหาวิทยาลัย/บริษัท</label>
                                    ...
                                    <input class="form-control placeholder-no-fix" type="text" placeholder="มหาวิทยาลัย/บริษัท" name="company" value="<?php echo e(old('company')!=null ? old('company') : $user->company); ?>" />
                            </div>
                            <div class="form-group">
                                <label class="control-label">เลขบัตรประจำตัวประชาชน</label>
                                    ...
                                    <input class="form-control placeholder-no-fix" type="text" placeholder="เลขบัตรประจำตัวประชาชน" name="citizen_id" value="<?php echo e(old('citizen_id')!=null ? old('citizen_id') : $user->citizen_id); ?>" />
                            </div>
                            <div class="form-group">
                                <label class="control-label">Passport ID</label>
                                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                                    <label class="control-label visible-ie8 visible-ie9">Passport ID</label>
                                    <input class="form-control placeholder-no-fix" type="text" placeholder="Passport ID" name="passport_id" value="<?php echo e(old('passport_id')!=null ? old('passport_id') : $user->passport_id); ?>" disabled="true" />
                            </div>
                            <div class="form-group">
