...
<input type="hidden" name="hidcname" id="hidcname" value="<?php echo e((isset($_COOKIE['setaccessbio']) ? $_COOKIE['setaccessbio'] : '')); ?>">
<?php $__env->stopSection(); ?>
                                    ...
                                    "mRender": function (data, type, full) {
                                        ...
                                        if (String(full.biobookingstatus) === '0') {
                                            if (days >= 2) {
                                                ...
                                                if (tdif < 15 && jQuery.inArray(String(full.biobookingteacherid), res) !== -1) {
...
//                                                if (days < 2) {
//                                                    if (days < 2 && days >= 1) {
//                                                        return "<a class='btn btn-danger btn-sm' href='#' placename onclick='return Canclebefore1day(\"" + full.biobookingid + "\")'><span class='glyphicon glyphicon-trash'></span> ยกเลิกการนัด</a>";
//                                                    }
//
//                                                    if (tdif < 15) {
//                                                        return "<a class='btn btn-primary btn-sm' href='#' onclick='return Opencfmuse(\"" + full.biobookingid + "\")'><span class='glyphicon glyphicon-check'></span> เข้าใช้งาน</a>";
