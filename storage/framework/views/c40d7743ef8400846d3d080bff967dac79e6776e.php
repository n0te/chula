    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-sidebar-menu">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="/">
                        <img src="/public/assets/global/img/logo.png" alt="logo" class="logo-default" /> </a>
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <span class="username username-hide-on-mobile"> <?php echo e($user->firstname); ?> </span>
        ...
        <div class="page-container">
			...
			<?php if(Utility::isMemberOfModule(1, Auth::user()->id) || Utility::isAdminOfModule(1, Auth::user()->id)): ?>
                        <li class="nav-item">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-diamond"></i>
                                <span class="title">Extramural Research Funds</span>
			...
			<?php endif; ?>
			<?php if(Utility::isMemberOfModule(2, Auth::user()->id) || Utility::isAdminOfModule(2, Auth::user()->id)): ?>
                        <li class="nav-item">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-diamond"></i>
			...
			<?php endif; ?>
			<?php if(Utility::isMemberOfModule(3, Auth::user()->id) || Utility::isAdminOfModule(3, Auth::user()->id)): ?>
                        <li class="nav-item">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-diamond"></i>
                            ...
                            <ul class="sub-menu"> 
                                ...
                                <?php if(Utility::isTeacher(Auth::user()->email)): ?>
                                <li class="nav-item  ">
			...
			<?php endif; ?>
			<?php if(Utility::isMemberOfModule(4, Auth::user()->id) || Utility::isAdminOfModule(4, Auth::user()->id)): ?>
                        <li class="nav-item">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-diamond"></i>
			...
			<?php endif; ?>
			<?php if(Utility::isAdminOfModule(1, Auth::user()->id)): ?>
                        <li class="nav-item">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-settings"></i>
			...
			<?php endif; ?>
			<?php if(Utility::isAdminOfModule(2, Auth::user()->id)): ?>
                        <li class="nav-item">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-settings"></i>
			...
			<?php endif; ?>
			<?php if(Utility::isAdminOfModule(3, Auth::user()->id)): ?>
                        <li class="nav-item">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-settings"></i>
			...
			<?php endif; ?>
			<?php if(Utility::isAdminOfModule(4, Auth::user()->id)): ?>
                        <li class="nav-item">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-settings"></i>
