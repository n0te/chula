            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase">ตารางกลุ่มเครื่องมือทั้งหมด</span>
                    </div>
                    <div class="actions">

                        <a href="#" onclick="OpenAddGroup(); return false;" class="btn green-meadow">
                            <i class="fa fa-plus"></i> เพิ่มกลุ่มเครื่องมือ</a>
                            ...
                            columns: [
                                ...
                                {"bVisible": true, "bSearchable": false, "bSortable": false,
                                    ...
                                    "mRender": function (data, type, full) {
                                        return " <a class='btn btn-primary btn-sm' href='#' onclick='return OpenEditEquipment(\"" + full.equipmentid + "\")'><span class='glyphicon glyphicon-file'></span> จอง</a>";
                                    }
                                }
                            ]
                        });
