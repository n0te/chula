        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="/anibooking" class="btn green-meadow">
                            <i class="fa fa-plus"></i> จองห้องแล็ป</a>
                    </div>
                </div>
...
<input type="hidden" name="hidcname" id="hidcname" value="<?php echo e((isset($_COOKIE['setaccessani']) ? $_COOKIE['setaccessani'] : '')); ?>">
<?php $__env->stopSection(); ?>
                        ...
                        $('#tblReviewform').DataTable({
                            ...
                            columns: [//`bookingid``bookingdate``bookingstarttime``bookingendtime``equipmentname``equipmentpicturename`
                                ...
                                {"bVisible": true, "bSearchable": false, "bSortable": false,
                                    "mData": null,
                                    "mRender": function (data, type, full) {
                                        return  moment(full.anibookingdate + 'T' + full.anibookingstarttime).format("HH:mm") + " - " + moment(full.anibookingdate + 'T' + full.anibookingendtime).format("HH:mm");
                                    }
                                },
                                {"bVisible": true, "bSearchable": false, "bSortable": false,
                                    "mData": null,
                                    "mRender": function (data, type, full) {
                                        ...
                                        } else if (String(full.anibookingstatus) === '1') {
                                ...
                                {"bVisible": true, "bSearchable": false, "bSortable": false,
                                    ...
                                    "mRender": function (data, type, full) {
                                        ...
                                        var res = cname.split(".");
                                        var start = new Date(full.anibookingdate),
                                                end = moment(),
...
//                                        }
                    ...
                    function DeleteByID() {
                        $.ajax({
                            url: '/deleteAniBookingByIDByUser/' + $("#hidbookingid").val(),
                            method: 'get',
                            dataType: 'json',
                            contentType: false,
                            processData: false,
                    ...
                    function cfmByID() {
                        $.ajax({
                            url: '/cfmAniBookingByID/' + $("#hidbookingid").val(),
                            method: 'get',
                            dataType: 'json',
                            contentType: false,
                            processData: false,
                            ...
                            success: function (data) {
                                if (data.message === 'saved') {
                                    $('#tblReviewform').DataTable().ajax.reload();
                                    $('#mdlBookingCfmUse').modal('toggle');
                                    sudoNotify.success("เข้าใช้งานห้องแล๊ปเรียบร้อย");
                                }
                            }
                        });
                    }
