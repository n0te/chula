...
<script>
                        ...
                        $('#tblReviewform').DataTable({
                            ...
                            columns: [//`bookingid``bookingdate``bookingstarttime``bookingendtime``equipmentname``equipmentpicturename`
                                ...
                                {"bVisible": true, "bSearchable": false, "bSortable": false,
                                    ...
                                    "mData": null,
                                    "mRender": function (data, type, full) {
                                        return "<a class='btn btn-danger btn-sm' href='#' onclick='return OpenDelete(\"" + full.biobookingid + "\")'><span class='glyphicon glyphicon-trash'></span> ลบ</a>";
                    ...
                    function DeleteByID() {
                        $.ajax({
                            url: '/deleteBioBookingByID/' + $("#hidbiobookid").val(),
                            method: 'get',
                            dataType: 'json',
                            contentType: false,
                            processData: false,
